...
12. `wf_1c478604-662` "pyrefly-leblanc-art-lora-round2" (launched 05:10 EDT 09-23): datasets grown with the round-1 outputs scored 6+, Logos idle hand repaired first, retrain, re-render with LoRA r2 + OpenPose, in-game scale check, independent judges. OWNS public/art/characters/{leblanc,ormi,logos}/**, docs/concepts/chapters/leblanc/lora/**, tools/gen/lora-*.mjs, D:/Tools/pyrefly-lora/**. Candidates for release 10.

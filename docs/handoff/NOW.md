...
> **USAGE MODE: NORMAL again at 11:40 EDT 09-23, Bailey's words: "Ok continue working pretty please" and "Continue on!", with ultracode switched on** (the driver had tightened to conserve at 09:45; this returns to Bailey's own 09-22 setting). Reading 11:20 EDT: weekly all-models 57 percent used, weekly Fable 24, 5-hour 17; the week resets 2026-09-26 07:00 EDT. Burn this morning was about 2.7 points an hour: at that pace protect (80 used) comes around 20:00 EDT tonight, so size every fan-out and re-read before each one.
...
13. `wf_313554e4-39b` release.js ROUND 09 (launched 04:15 EDT 09-23): cut of `5ddfde3` (full suite green, build smoke green), deep candidate review (round-09: HOLD on PR-0122), DEPLOYED 07:55 EDT on the override, records `e9b9bed`, live check done (UNVERIFIED as above), and the DEEP REVIEW OF THE LIVE BUILD is RUNNING NOW (its agents: this line is about you, carry on). Owns `critic/**` for this build. No other workflow may start while it runs (conserve).

...
> **USAGE MODE: CONSERVE, tightened by the driver at 09:45 EDT 09-23** (weekly all-models 53 percent used, weekly Fable 23, 5-hour 0; 47 percent of the allowance left with 2d 21h of the week left, so RUBRIC §9 says conserve: one workflow at a time, Sonnet unless engine / presenter / verifier, NO art agents, one repair cycle, batch shared-system changes into one deep review). Bailey set NORMAL by word on 09-22 and may set it again by word; agents only tighten.

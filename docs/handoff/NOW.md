...
15. Sonnet real-input check of LIVE-HUD-HIDDEN on the live URL (GPU browser, 1600x900, keyboard only, chapters IV and VI, 120 s poll, then Active mode): proof shots to `docs/screenshots/live-09/`. If it confirms the HUD never appears, that is a CRITICAL live regression and a hotfix goes ahead of everything.
...
- https://baileypillon.github.io/pyrefly-reprise/ = `main 5ddfde3`, bundle `Jw5R1yWQ`, deployed 2026-09-23 07:55 EDT under
  ...
  obligation). Contents and verdicts: see the 09:55 EDT header line. Obligations in `critic/pending/5ddfde3.json`: live

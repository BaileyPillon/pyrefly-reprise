...
await page.route('**/art/portraits/seymour-macalania.png*', (r) => r.fulfill(png(A + 'portraits/seymour-omnis.png')));
await page.goto('http://127.0.0.1:5740/', { waitUntil: 'commit', timeout: 180000 });

...
const g = {
  ...
  12: { class_type: 'SaveImage', inputs: { filename_prefix: 'pyrefly/r3-seymour-up', images: ['7', 0] } },
};
let model = ['1', 0];
...
S.forEach((seed, i) => {
  ...
  g[k + 2] = { class_type: 'SaveImage', inputs: { filename_prefix: `pyrefly/r3-seymour-s${seed}`, images: [String(k + 1), 0] } };
});

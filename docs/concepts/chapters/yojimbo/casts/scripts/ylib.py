"""Shared helpers for the Yojimbo cast candidates (FFX only). Pixel ops only; no GPU here."""
import numpy as np, cv2
from PIL import Image

REPO = 'D:/Final Fantasy'
SCR = 'D:/Tools/pyrefly-scratch/yoj-casts'
OUT = 'D:/Tools/pyrefly-art-backup/candidates/2026-09-24-yojimbo-casts'
IDLE = {k: f'{REPO}/public/art/characters/{k}/idle.png' for k in ('yojimbo-cavern', 'daigoro', 'ginnem')}

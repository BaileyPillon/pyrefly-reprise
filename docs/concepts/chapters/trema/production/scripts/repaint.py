...
tmpdir = 'D:/Tools/pyrefly-scratch/ch1215/trema/tmp'
...
g = upload(gp, f'ch1215-trema-g-{tag}.png'); m = upload(mp, f'ch1215-trema-m-{tag}.png')
wf = {
 ...
 '10': {'class_type': 'SaveImage', 'inputs': {'images': ['9', 0], 'filename_prefix': 'ch1215-trema/repaint'}},
}
req = urllib.request.Request(BASE + '/prompt', data=json.dumps({'prompt': wf, 'client_id': 'ch1215-trema'}).encode(), headers={'Content-Type': 'application/json'})

...
tmpdir = 'D:/Tools/pyrefly-scratch/fa-prod/tmp'
...
g = upload(gp, f'fa-prod-g-{tag}.png'); m = upload(mp, f'fa-prod-m-{tag}.png')
wf = {
 ...
 '10': {'class_type': 'SaveImage', 'inputs': {'images': ['9', 0], 'filename_prefix': 'fa-prod/repaint'}},
}
req = urllib.request.Request(BASE + '/prompt', data=json.dumps({'prompt': wf, 'client_id': 'fa-prod'}).encode(), headers={'Content-Type': 'application/json'})

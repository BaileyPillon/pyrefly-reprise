...
set -u
LOG=/d/Tools/pyrefly-scratch/fa-prod/comfy-logs
mkdir -p "$LOG"
while true; do
...
cd "/d/Final Fantasy"
export TMP=D:/Tools/pyrefly-scratch/fa-prod/tmp TEMP=D:/Tools/pyrefly-scratch/fa-prod/tmp
COMFY_LOG_DIR="D:/Tools/pyrefly-scratch/fa-prod/comfy-logs" node tools/gen/comfy.mjs "$@"
rc=$?

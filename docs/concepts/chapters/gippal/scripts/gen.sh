...
set -u
LOG=D:/Tools/pyrefly-scratch/gippal-options/comfy-logs
export TEMP=D:/Tools/pyrefly-scratch/gippal-options/tmp TMP=D:/Tools/pyrefly-scratch/gippal-options/tmp
while true; do

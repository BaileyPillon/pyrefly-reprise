...
tmpdir = 'D:/Tools/pyrefly-scratch/ch1215/gippal/tmp'
...
g = upload(gp, f'gip-prod-g-{tag}.png'); m = upload(mp, f'gip-prod-m-{tag}.png')
wf = {
 ...
 '10': {'class_type': 'SaveImage', 'inputs': {'images': ['9', 0], 'filename_prefix': 'gip-prod/repaint'}},
}
req = urllib.request.Request(BASE + '/prompt', data=json.dumps({'prompt': wf, 'client_id': 'gip-prod'}).encode(), headers={'Content-Type': 'application/json'})

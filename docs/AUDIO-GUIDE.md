...
| `boss-seymour-macalania` | Seymour and the Guado Guardians, Chapter VII (Macalania Temple) | FFX |
| `boss-yojimbo` | Lady Ginnem's Yojimbo, Chapter IX (Cavern of the Stolen Fayth); registered, not yet wired into the chapter's data | FFX |
...
| `boss-seymour-macalania` — *"The Courtesy"* | C# minor, 126 bpm | 64 bars, grown from sketch A (Bailey's pick, 2026-09-24). Harpsichord pavane and pizzicato alone (1–4); SEYMOUR on oboe, an octave above `boss-seymour`, the minor-third sequence (5–12); violins take it, SEYMOUR_MIRROR in the cellos, the dance thinned to half-bars (13–20); the bow on harpsichord, the decline finished by the oboe, the mirror on clarinet (21–28); the curdle: a written semitone decline, violins then clarinet, that never reaches the tonic, no harpsichord (29–36); the dance as if nothing happened (37–40); the rise: tutti with low brass and a struck bell, the sequence one step further to A#, thrown home, then a plagal amen iv → bVI (41–52); composure in the quartet, then the oboe (53–60); the dance with the #4 held under it (61–64). The dance bows on the last half-bar of every four-bar phrase: never an ostinato. Loop 16 → 256. |
| `boss-yojimbo` — *"The Summoner's Sorrow"* | C minor (Aeolian), 132 bpm | 48 bars, grown from sketch A (Bailey's pick, O-6, 2026-09-24). Grief: the line on solo cello over felt piano, a string floor, no pulse (1–8); the pulse joins, bowed eighths and taiko, the violin takes the line an octave up, the cello answers (9–16); the duty: the line two steps up the mode on one horn, a violin descant (17–24, new); the line in violin and cello octaves, horns holding (25–32, new); the strain climbs with horns, a timpani roll (33–38); the crack: tutti `Abmaj7`, violin on Ab5, everything but the piano stops (39–40); control, quieter, the plagal amen (41–48). No dominant anywhere. Loop 32 → 192. |

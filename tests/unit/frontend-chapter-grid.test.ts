...
describe('the board', () => {
  ...
  it('holds fifteen cards: fourteen playable chapters (Leblanc, Evrae, Yojimbo, Natus, Fallen Aeons, Omnis, Trema, Isaaru and the Den of Woe now landed) and one still coming', () => {

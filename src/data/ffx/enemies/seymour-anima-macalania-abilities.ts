...
import { animaBoost, animaOblivion, animaPainBoss } from './seymour-anima-macalania-anima-abilities.ts';
...
// ---------------------------------------------------------------------------
// Anima (m125) — §4.3 [decompiled]: in `./seymour-anima-macalania-anima-abilities.ts`
// ---------------------------------------------------------------------------

export { animaBoost, animaOblivion, animaPainBoss };

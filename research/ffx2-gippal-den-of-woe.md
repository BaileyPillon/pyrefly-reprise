...
| Immune | Instant Death, Petrify, Sleep, Silence, Darkness, Poison, Confuse, Berserk, Curse, Eject, **Slow**, Stop, Doom, Delay, Interrupt, fractional damage | SinirothX + wiki + Split_Infinity `[verified: 3 sources]`. The **Breaks are not on the list**, so they land `[derived]`. |
